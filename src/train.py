...
if __name__ == '__main__':
    ...
    parser.add_argument('--audio_model_id',
                        default=None,
                        help='Huggingface model path to the audio model.')
    parser.add_argument('--animation_model_id',
                        default=None,
                        help='Huggingface model path to the animation model.')
    ...
    model_stack = build_model(text_model_id=args.text_model_id,
                              ...
                              animation_model_id=args.animation_model_id,
    ...
    logging.info(f"Tokenizer type: {type(model_stack['tokenizer'])}")
    ...
    output_dir = make_save_folder(args.output_dir)
